function overlaps = InteractMovieOverlap(moviecell,numreshuffs)
...
title({'Red: Pairs of non-interaction movies.  Blue: Interaction - Non-Interaction pairs';...
    ['NonInt-NonInt: ',num2str(mean(overlaps.nonnonpercs)),'\pm',num2str(std(overlaps.nonnonpercs)),'.  Int-NonInt: ',num2str(mean(overlaps.intnonpercs)),'\pm',num2str(std(overlaps.intnonpercs)),'.'];...
    kstext})
xlabel('% overlap')
...
xlabel('Difference in % overlap: nn-in')
...
title(['Non-Non Overlap.  ',num2str(nnpercentile),'th percentile.'])
...
xlabel('Percent overlap')
ylabel('Number of datasets')
title(['Int-Non Overlap.  ',num2str(inpercentile),'th percentile.'])
...
xlabel('Percent overlap')
ylabel('Number of datasets')
title(['Int-Int Overlap.  ',num2str(iipercentile),'th percentile.'])
...
numslices = sidx;
title([num2str(numsignifdiffs),' out of ',num2str(numslices),' slices showed significant difference in overlap between NN and IN.'])
