...
%
%     Import Axon's .ATF text files (incorporating a special text header)
%     into Matlab.
%
%     This function loads data from an Axon Text File (.ATF 1.0) (Copyright
%     © 1995 Axon Instruments)
%     and automatically import columns of values into Matlab, as a
%     numerical data matrix. 
%
%     The input filename must be a string, including the file extension
%     (e.g. 'patchexperiment.atf').
%
%     Do you want to know more about .ATF files?
%     An .ATF file is a structured text file format that is commonly used
%     for data export and import
%     by all of Axon's programs (http://www.axon.com), whether for the PC
%     or the Mac.
%
%     The first output:  HEADER,   is the header information, returned as a
%     text array.
%     The second output: LABELS,   is a (1xNc) cell array containing the
%     (Nc) column titles and corresponding units.
%     The third output:  COMMENTS, is a (1xNcm) cell array containing the
%     (Ncm) existing comments and corresponding indexes to DATA.
%     The fourth output: DATA,     is a double array, with the same size as
%     the data in the file, one row per line of ASCII data in the file.
%
%     © 2002 - Michele Giugliano, PhD (http://www.giugliano.info) (Bern,
%     Friday March 8th, 2002 - 20:09)
...
%
%     See also IMPORT_ABF, LOAD, SAVE, SPCONVERT, FSCANF, FPRINTF, STR2MAT,
%     HDRLOAD.
...
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%
% In the following, I assumed (as it is not clearly specified by Axon) that
% when the 'Comment ()' field exists, it 
% corresponds to the rightmost column in the .ATF file (i.e. comments are
% always the last rightmost column).
%
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%-------------------------------------------------------------------------
