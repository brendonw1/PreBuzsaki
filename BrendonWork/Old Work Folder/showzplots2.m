function showzplots2(cutoff,areath)
% same as "showzplots" but only displays graphs and contours of cells with
% positive initial slopes in their brightness vs. time graph.
