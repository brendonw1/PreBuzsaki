...
disp (strcat('Mean Total TSTrain Response/Total Spont Response = ',num2str(totals(1).avgtrainDspont)))
disp (strcat('SD of Total TSTrain Response/Total Spont Response = ',num2str(totals(1).sdtrainDspont)))
disp (strcat('Mean Total TSTrain Response/Total Spont Response = ',num2str(totals(1).avgspontDtrain)))
disp (strcat('SD of Total TSTrain Response/Total Spont Response = ',num2str(totals(1).sdspontDtrain)))
disp (' ')
disp (strcat('Mean Overlap of TSTrain and Spont.../Train = ',num2str(totals(1).avgtrspoverlapDtrain)))
disp (strcat('SD of Overlap of TSTrain and Spont.../Train = ',num2str(totals(1).sdtrspoverlapDtrain)))
disp (strcat('Mean Overlap of TSTrain and Spont.../Spont = ',num2str(totals(1).avgtrspoverlapDspont)))
disp (strcat('SD of Overlap of TSTrain and Spont.../Spont = ',num2str(totals(1).sdtrspoverlapDspont)))
disp (' ')
disp (strcat('Proportion of cells never on in all Trains = ',num2str(totals(1).upto0tstraintotal(1)),'/',num2str(totals(1).upto0tstraintotal(2)),'=',num2str(totals(1).upto0tstraintotal(1)/totals(1).upto0tstraintotal(2))))
disp (strcat('Proportion of cells on in 0-1/3 of all Trains = ',num2str(totals(1).upto33tstraintotal(1)),'/',num2str(totals(1).upto33tstraintotal(2)),'=',num2str(totals(1).upto33tstraintotal(1)/totals(1).upto33tstraintotal(2))))
disp (strcat('Proportion of cells on in 1/3-2/3 of all Trains = ',num2str(totals(1).upto66tstraintotal(1)),'/',num2str(totals(1).upto66tstraintotal(2)),'=',num2str(totals(1).upto66tstraintotal(1)/totals(1).upto66tstraintotal(2))))
disp (strcat('Proportion of cells on in 2/3-99% of all Trains = ',num2str(totals(1).upto99tstraintotal(1)),'/',num2str(totals(1).upto99tstraintotal(2)),'=',num2str(totals(1).upto99tstraintotal(1)/totals(1).upto99tstraintotal(2))))
disp (strcat('Proportion of cells on in all Trains = ',num2str(totals(1).above99tstraintotal(1)),'/',num2str(totals(1).above99tstraintotal(2)),'=',num2str(totals(1).above99tstraintotal(1)/totals(1).above99tstraintotal(2))))
disp (' ')
disp (strcat('Proportion of cells never on in all Sponts = ',num2str(totals(1).upto0sponttotal(1)),'/',num2str(totals(1).upto0sponttotal(2)),'=',num2str(totals(1).upto0sponttotal(1)/totals(1).upto0sponttotal(2))))
disp (strcat('Proportion of cells on in 0-1/3 of all Sponts = ',num2str(totals(1).upto33sponttotal(1)),'/',num2str(totals(1).upto33sponttotal(2)),'=',num2str(totals(1).upto33sponttotal(1)/totals(1).upto33sponttotal(2))))
disp (strcat('Proportion of cells on in 1/3-2/3 of all Sponts = ',num2str(totals(1).upto66sponttotal(1)),'/',num2str(totals(1).upto66sponttotal(2)),'=',num2str(totals(1).upto66sponttotal(1)/totals(1).upto66sponttotal(2))))
disp (strcat('Proportion of cells on in 2/3-99% of all Sponts = ',num2str(totals(1).upto99sponttotal(1)),'/',num2str(totals(1).upto99sponttotal(2)),'=',num2str(totals(1).upto99sponttotal(1)/totals(1).upto99sponttotal(2))))
disp (strcat('Proportion of cells on in all Sponts = ',num2str(totals(1).above99sponttotal(1)),'/',num2str(totals(1).above99sponttotal(2)),'=',num2str(totals(1).above99sponttotal(1)/totals(1).above99sponttotal(2))))