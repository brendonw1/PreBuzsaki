function ons=tester2(pixels,contours,lengths);
...
%             fc2=findmatrixnofig(frame2,moviemean2+1.25*movienoise2,meandiam+1.5,1000);%use contours to detect regions of brightness (calcium change);
...
%             fc10=findmatrixnofig(frame10,moviemean10+1.25*movienoise10,meandiam+1.5,1000);%use contours to detect regions of brightness (calcium change);
%             fc=cat(2,fc2,fc10);
