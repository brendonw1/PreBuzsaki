...
ttov(find(ttdist>goodperslice))=[];%don't plot values greater than goodperslice (arbitrary)
ttdist(find(ttdist>goodperslice))=[];
...
ssov(find(ssdist>goodperslice))=[];
ssdist(find(ssdist>goodperslice))=[];
