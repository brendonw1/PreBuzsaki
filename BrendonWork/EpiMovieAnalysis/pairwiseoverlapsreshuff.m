...
xlabel('Mean repeatablility of slice means in TT comparisons')
ylabel('Observations');
...
figure;hist(100*mean(shuffslicemeans.ss,2),100)
hold on
plot(100*mean(realslicemeans.ss),1,'*','color','r')
m=100*mean(mean(shuffslicemeans.ss,2));
s=100*std(mean(shuffslicemeans.ss,2));
xlabel('Mean repeatablility of slice means in SS comparisons')
ylabel('Observations');
title('Distribution in random Spont data sets vs observed (red)')
legend(['Obs = ',num2str(100*mean(realslicemeans.ss))],['Mean = ',num2str(m),', SD = ',num2str(s)])

figure;hist(100*mean(shuffslicemeans.ts,2),100)
hold on
plot(100*mean(realslicemeans.ts),1,'*','color','r')
m=100*mean(mean(shuffslicemeans.ts,2));
s=100*std(mean(shuffslicemeans.ts,2));
xlabel('Mean repeatablility of slice means in TS comparisons')
ylabel('Observations');
title('Distribution in random Trig data sets vs observed (red)')
legend(['Obs = ',num2str(100*mean(realslicemeans.ts))],['Mean = ',num2str(m),', SD = ',num2str(s)])