function makevnt(filename,cellnumb,contours,ms,percent,x,y);
%this will create a targets file for vovan fluoview with the centroids of
...
ts(:,end)=[0.000;0.000;-1.000;100.000;0.000;1.000];%specifying dummy target parameters
