function cta_find_all_inactives(analyzerHandles)

warning off
notnullcells = ~analyzerHandles.data.nullContours;
newactivesname = ['AllInactivesFrom_'];
...
analyzerHandles.data.activitymtxs{end+1} = inactives;
analyzerHandles.data.onsmtxs{end+1} = inactives;
