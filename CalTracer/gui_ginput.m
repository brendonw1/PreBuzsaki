function [out1,out2,out3] = gui_ginput(fig, arg1)
%GUI_GINPUT Graphical input from mouse.
%   [X,Y] = GUI_GINPUT(N) gets N points from the current axes and returns 
...
%
%   [X,Y] = GUI_GINPUT gathers an unlimited number of points until the
%   return key is pressed.
% 
%   [X,Y,BUTTON] = GUI_GINPUT(N) returns a third result, BUTTON, that 
%   contains a vector of integers specifying which mouse button was
%   used (1,2,3 from left) or ASCII numbers if a key on the keyboard
%   was used.

%   Copyright 1984-2004 The MathWorks, Inc.
%   $Revision: 1.1 $  $Date: 2006/05/16 03:49:56 $
