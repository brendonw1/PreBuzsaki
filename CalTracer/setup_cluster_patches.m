...
%xlen = [1/handles.exp.globals.fs ...
%	handles.exp.globals.numImagesProcess/handles.exp.globals.fs];
...
% 		  'caltracer(''unhighlight_cluster_callback'', gcbo, guidata(gcbo))');
    ...
    set(cph(i), 'ButtonDownFcn','caltracer(''clustermap_buttondown_callback'',gcbo,guidata(gcbo))');    
end
