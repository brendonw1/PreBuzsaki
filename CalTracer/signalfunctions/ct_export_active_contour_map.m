...
activecells = handles.appData.activeCells;
contoursstruct = handles.exp.contours;
...
xlim([1 size(handles.exp.tcImage.image,2)]);
ylim([1 size(handles.exp.tcImage.image,1)]);
axis off
