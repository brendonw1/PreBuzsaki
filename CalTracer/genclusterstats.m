...
%for n = 1:handles.exp.numContours
%    handles.exp.contours(n).intensityclean = p.cleanContourTraces(n,:);
%    if (handles.exp.haloMode)
%	handles.exp.contours(n).haloIntensityClean = p.cleanHaloTraces(n,:);
%    end
%end
